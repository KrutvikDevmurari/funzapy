...
const BottomNavigation = () => {
    return (
        <div className="app-width fixed inset-x-0 bottom-0  w-[500px]">
            <div id="bottom-navigation"
                className="text-black mb-5 rounded-xl mx-5 shadow-lg shadow-gray-500/300  bg-amber-300 drop-shadow-2xl">
